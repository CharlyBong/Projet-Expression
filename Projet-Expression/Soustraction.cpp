...
* \brief Implémentation de la classe Soustraction
* \author Charles Bong.
* \date 14 Mars 2015
*/
...
Soustraction::Soustraction(Operande* op_gauche, Operande* op_droit)
{
...
void Soustraction::afficherPolonaise()
{
...
void Soustraction::afficherSimple()
{
